...
def main():
    ...
    train_jsonl_file = "/Users/jmoore/Desktop/Project2/data/train.jsonl"   # Update path if needed
    test_jsonl_file = "/Users/jmoore/Desktop/Project2/data/test.jsonl"     # Update path if needed
    ...
    valid_size = int(0.1 * len(full_train_dataset))
